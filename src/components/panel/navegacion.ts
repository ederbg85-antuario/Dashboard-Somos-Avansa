...
export const MENU: Grupo[] = [
  {
    ...
    entradas: [
      ...
      { href: "/funnel", etiqueta: "Funnel comercial", icono: "embudo", modulo: "crm", prefijo: true,
        descripcion: "De la adquisición al ingreso" },
    ...
    entradas: [
      {
        ...
        subentradas: [
          ...
          { href: "/marketing/sitio-web", etiqueta: "Sitio web", descripcion: "Visitas, fuentes y acciones del sitio", prefijo: true },
          { href: "/marketing/meta", etiqueta: "Publicidad", descripcion: "Campañas y rendimiento publicitario", prefijo: true },
          { href: "/marketing/search-console", etiqueta: "SEO en Google", descripcion: "Visibilidad y búsquedas orgánicas", prefijo: true },
